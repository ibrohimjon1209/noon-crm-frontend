        ...
        {data.map((item, index) => (
          ...
          >
            ...
            <div className="flex flex-col gap-[5px] justify-center">
              <h1 className={item.label.length > 16 ? `font-[roboto] font-[400] text-[13px] leading-[14.6px] text-[rgba(0,0,0,0.5)]` : `font-[roboto] font-[400] text-[16px] leading-[18.75px] text-[rgba(0,0,0,0.5)]`}>
                {item.label}
              </h1>
