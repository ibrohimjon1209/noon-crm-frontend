...
const Add_modal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="w-full h-[135vh] fixed inset-0 z-50 flex items-center justify-center">
      ...
      ></div>
      <div
        className={`relative bg-white rounded-[10px] w-[625px] h-[540px] z-50 transition-all duration-300 ease-out ${
      ...
      >
        ...
        <div className="pt-[20px] px-6 flex h-[100%] flex-col w-[100%]">
          <div className="space-y-[20px]">
            <label className="font-roboto font-[400] block text-[18px] leading-[21.09px] text-black">Foiz nomi</label>
            <input
              type="text"
          ...
          <div className="space-y-[20px] pt-[30px]">
            <label className="font-roboto font-[400] block text-[18px] leading-[21.09px] text-black">Foiz</label>
            <input
              type="text"
              className="w-full h-[45px] p-2 border border-gray-300 text-black text-[17px] bg-[#F2EEEE] rounded-md"
              required
