      ...
      <div className="flex w-full h-[100%] flex-col justify-center gap-[16px] items-center">
        ...
        <div className="flex flex-col items-center w-[calc(60vw)] overflow-y-scroll h-auto bg-white rounded-t-[15px] rounded-b-[1px] shadow-lg" style={{ scrollbarWidth: "thin" }}>
          <div className="flex mt-[10px] flex-row items-center w-[90%] py-[19px] border-b-[1px] border-[#D9D9D9]">
            ...
            <p className="font-inter font-[600] text-[16px] leading-[18.15px] text-[#404040] w-[25%]">Balans</p>
          </div>
          {third_person_data.map((item, index) => (
            <div key={index} className="flex flex-row items-center w-[90%] py-[19px] border-b-[1px] border-[#D9D9D9]">
              ...
              <p className="font-inter font-[500] text-[16px] leading-[18.15px] text-[#404040] w-[26%]">
                {formatPhoneNumber(item.phone_number)}
              </p>
              <p className="font-inter font-[500] text-[16px] leading-[18.15px] text-[#404040] w-[8%]">{item.balance}</p>

              <div className="ml-[14%] pl-[50px] flex gap-[34px] w-[10%] justify-center">
                <img
                  src={editIcon}
                  alt="Edit"
          ...
          <div className="flex pr-[34px] mt-[50px] mb-[15px]">
            <h1 className="font-inter font-[600] text-[15px] text-[rgba(64,64,64,1)]">Umumiy son: {third_person_data.length}</h1>
          </div>
        </div>
