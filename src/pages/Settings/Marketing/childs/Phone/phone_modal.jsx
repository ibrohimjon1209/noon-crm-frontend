...
const PhoneModal = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="w-full h-[135vh] fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div
                className={`relative bg-white rounded-[10px] w-[625px] h-[649px] z-50 transition-all duration-300 ease-out ${isAnimating ? "translate-y-1 opacity-100" : "-translate-y-20 opacity-0"
                    }`}
            >
                ...
                <div className="pt-[20px] px-6 flex h-[100%] flex-col w-[100%]">
                    <div className="space-y-[20px]">
                        <label className="font-roboto font-[400] block text-[18px] leading-[21.09px] text-black">Bo'lim</label>
                        <input
                            type="text"
                    ...
                    <div className="flex items-center gap-4 mt-5 text-gray-800 font-medium">
                        <h2 className="ml-4">Rangi:</h2>
