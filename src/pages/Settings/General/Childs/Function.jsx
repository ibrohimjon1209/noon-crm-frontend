...
const Function = () => {
  ...
  const [attendance_assistant_limit, set_attendance_assistant_limit] =
    useState(false);
  const [attendance_assistant_block, set_attendance_assistant_block] =
    useState(false);
  ...
  return (
    <div
      className="w-full mt-[-41px] pt-[41px] bg-transparent overflow-hidden overflow-y-scroll"
      style={{
        ...customScrollbar,
        overflowY: "auto",
        scrollbarWidth: "thin",
            ...
            <div className="mt-[10px]">
              <div className="w-full h-[68px] border-b-[1.5px] border-[#D9D9D9] flex justify-between items-center px-[10px]">
                <div className="w-[677px]">
                  <h1 className="font-inter font-[500] text-[18px] leading-[21.78px] text-[#404040]">
                    Band xona
                  </h1>
                </div>
                <div>
                  <div
                    ...
                    className={`rounded-[40px] ${
                      busy_room ? "bg-[#264E86]" : "bg-white"
                    } w-[38px] flex ${
                      busy_room ? "justify-end" : "justify-start"
                    } duration-[0.1s] ease-out cursor-pointer items-center px-[2px] border-[#264E86] border-[4px] h-[24px]`}
                  >
                    <div
                      className={`h-[14px] ${
                        busy_room ? "bg-white" : "bg-[#264E86]"
                      } w-[14px] rounded-[50%] duration-[0.1s] ease-out`}
                    ></div>
                  </div>
                </div>
              </div>
              <div className="w-full h-[68px] border-b-[1.5px] border-[#D9D9D9] flex justify-between items-center px-[10px]">
                ...
                <div>
                  <div
                    ...
                    className={`rounded-[40px] ${
                      functionality ? "bg-[#264E86]" : "bg-white"
                    } w-[38px] flex ${
                      functionality ? "justify-end" : "justify-start"
                    } duration-[0.1s] ease-out cursor-pointer items-center px-[2px] border-[#264E86] border-[4px] h-[24px]`}
                  >
                    <div
                      className={`h-[14px] ${
                        functionality ? "bg-white" : "bg-[#264E86]"
                      } w-[14px] rounded-[50%] duration-[0.1s] ease-out`}
                    ></div>
                  </div>
                </div>
              ...
              <div className="w-full h-[68px] border-b-[1.5px] border-[#D9D9D9] flex justify-between items-center px-[10px]">
                ...
                <div>
                  <div
                    ...
                    className={`rounded-[40px] ${
                      busy_teacher ? "bg-[#264E86]" : "bg-white"
                    } w-[38px] flex ${
                      busy_teacher ? "justify-end" : "justify-start"
                    } duration-[0.1s] ease-out cursor-pointer items-center px-[2px] border-[#264E86] border-[4px] h-[24px]`}
                  >
                    <div
                      className={`h-[14px] ${
                        busy_teacher ? "bg-white" : "bg-[#264E86]"
                      } w-[14px] rounded-[50%] duration-[0.1s] ease-out`}
                    ></div>
                  </div>
                </div>
              ...
              <div className="w-full h-[68px] border-b-[1.5px] border-[#D9D9D9] flex justify-between items-center px-[10px]">
                <div className="w-[677px]">
                  <h1 className="font-inter font-[500] text-[18px] leading-[21.78px] text-[#404040]">
                    Davomatdan oldin topshiriq yaratish
                  </h1>
                </div>
                <div>
                  <div
                    ...
                    className={`rounded-[40px] ${
                      before_proceeding ? "bg-[#264E86]" : "bg-white"
                    } w-[38px] flex ${
                      before_proceeding ? "justify-end" : "justify-start"
                    } duration-[0.1s] ease-out cursor-pointer items-center px-[2px] border-[#264E86] border-[4px] h-[24px]`}
                  >
                    <div
                      className={`h-[14px] ${
                        before_proceeding ? "bg-white" : "bg-[#264E86]"
                      } w-[14px] rounded-[50%] duration-[0.1s] ease-out`}
                    ></div>
                  </div>
                </div>
              ...
              <div className="w-full h-[68px] border-b-[1.5px] border-[#D9D9D9] flex justify-between items-center px-[10px]">
                <div className="w-[677px]">
                  <h1 className="font-inter font-[500] text-[18px] leading-[21.78px] text-[#404040]">
                    Topshiriq yaratishdan oldin baholash
                  </h1>
                </div>
                <div>
                  <div
                    onClick={() =>
                      set_creating_assignment(!creating_assignment)
                    }
                    className={`rounded-[40px] ${
                      creating_assignment ? "bg-[#264E86]" : "bg-white"
                    } w-[38px] flex ${
                      creating_assignment ? "justify-end" : "justify-start"
                    } duration-[0.1s] ease-out cursor-pointer items-center px-[2px] border-[#264E86] border-[4px] h-[24px]`}
                  >
                    <div
                      className={`h-[14px] ${
                        creating_assignment ? "bg-white" : "bg-[#264E86]"
                      } w-[14px] rounded-[50%] duration-[0.1s] ease-out`}
                    ></div>
                  </div>
                </div>
              ...
              <div className="w-full h-[68px] border-b-[1.5px] border-[#D9D9D9] flex justify-between items-center px-[10px]">
                <div className="w-[677px]">
                  <h1 className="font-inter font-[500] text-[18px] leading-[21.78px] text-[#404040]">
                    Uchta darsga kelmaganlarni avtomatik guruhdan chiqarib
                    yuborish va o'quvchi adminiga avtotask qo'shilib qolishi
                  </h1>
                </div>
                <div>
                  <div
                    ...
                    className={`rounded-[40px] ${
                      remove_student ? "bg-[#264E86]" : "bg-white"
                    } w-[38px] flex ${
                      remove_student ? "justify-end" : "justify-start"
                    } duration-[0.1s] ease-out cursor-pointer items-center px-[2px] border-[#264E86] border-[4px] h-[24px]`}
                  >
                    <div
                      className={`h-[14px] ${
                        remove_student ? "bg-white" : "bg-[#264E86]"
                      } w-[14px] rounded-[50%] duration-[0.1s] ease-out`}
                    ></div>
                  </div>
                </div>
              ...
              <div className="w-full h-[68px] border-b-[1.5px] border-[#D9D9D9] flex justify-between items-center px-[10px]">
                <div className="w-[677px]">
                  <h1 className="font-inter font-[500] text-[18px] leading-[21.78px] text-[#404040]">
                    Moliya bo'limida o'qituvchi bo'yicha filtr
                  </h1>
                </div>
                <div>
                  <div
                    ...
                    className={`rounded-[40px] ${
                      finance_teacher ? "bg-[#264E86]" : "bg-white"
                    } w-[38px] flex ${
                      finance_teacher ? "justify-end" : "justify-start"
                    } duration-[0.1s] ease-out cursor-pointer items-center px-[2px] border-[#264E86] border-[4px] h-[24px]`}
                  >
                    <div
                      className={`h-[14px] ${
                        finance_teacher ? "bg-white" : "bg-[#264E86]"
                      } w-[14px] rounded-[50%] duration-[0.1s] ease-out`}
                    ></div>
                  </div>
                </div>
              ...
              <div className="w-full h-[68px] border-b-[1.5px] border-[#D9D9D9] flex justify-between items-center px-[10px]">
                ...
                <div>
                  <div
                    ...
                    className={`rounded-[40px] ${
                      group_for_school ? "bg-[#264E86]" : "bg-white"
                    } w-[38px] flex ${
                      group_for_school ? "justify-end" : "justify-start"
                    } duration-[0.1s] ease-out cursor-pointer items-center px-[2px] border-[#264E86] border-[4px] h-[24px]`}
                  >
                    <div
                      className={`h-[14px] ${
                        group_for_school ? "bg-white" : "bg-[#264E86]"
                      } w-[14px] rounded-[50%] duration-[0.1s] ease-out`}
                    ></div>
                  </div>
                </div>
              ...
              <div className="w-full h-[68px] border-b-[1.5px] border-[#D9D9D9] flex justify-between items-center px-[10px]">
                <div className="w-[677px]">
                  <h1 className="font-inter font-[500] text-[18px] leading-[21.78px] text-[#404040]">
                    Kassalar orasida tasdiqlash orqali ko'chirish
                  </h1>
                </div>
                <div>
                  <div
                    ...
                    className={`rounded-[40px] ${
                      moving_cases ? "bg-[#264E86]" : "bg-white"
                    } w-[38px] flex ${
                      moving_cases ? "justify-end" : "justify-start"
                    } duration-[0.1s] ease-out cursor-pointer items-center px-[2px] border-[#264E86] border-[4px] h-[24px]`}
                  >
                    <div
                      className={`h-[14px] ${
                        moving_cases ? "bg-white" : "bg-[#264E86]"
                      } w-[14px] rounded-[50%] duration-[0.1s] ease-out`}
                    ></div>
                  </div>
                </div>
              ...
              <div className="w-full h-[68px] border-b-[1.5px] border-[#D9D9D9] flex justify-between items-center px-[10px]">
                ...
                <div>
                  <div
                    ...
                    className={`rounded-[40px] ${
                      support_functions ? "bg-[#264E86]" : "bg-white"
                    } w-[38px] flex ${
                      support_functions ? "justify-end" : "justify-start"
                    } duration-[0.1s] ease-out cursor-pointer items-center px-[2px] border-[#264E86] border-[4px] h-[24px]`}
                  >
                    <div
                      className={`h-[14px] ${
                        support_functions ? "bg-white" : "bg-[#264E86]"
                      } w-[14px] rounded-[50%] duration-[0.1s] ease-out`}
                    ></div>
                  </div>
                </div>
              ...
              <div className="w-full h-[68px] border-b-[1.5px] border-[#D9D9D9] flex justify-between items-center px-[10px]">
                ...
                <div>
                  <div
                    ...
                    className={`rounded-[40px] ${
                      bot_attendance ? "bg-[#264E86]" : "bg-white"
                    } w-[38px] flex ${
                      bot_attendance ? "justify-end" : "justify-start"
                    } duration-[0.1s] ease-out cursor-pointer items-center px-[2px] border-[#264E86] border-[4px] h-[24px]`}
                  >
                    <div
                      className={`h-[14px] ${
                        bot_attendance ? "bg-white" : "bg-[#264E86]"
                      } w-[14px] rounded-[50%] duration-[0.1s] ease-out`}
                    ></div>
                  </div>
                </div>
              ...
              <div className="w-full h-[68px] border-b-[1.5px] border-[#D9D9D9] flex justify-between items-center px-[10px]">
                <div className="w-[677px]">
                  <h1 className="font-inter font-[500] text-[18px] leading-[21.78px] text-[#404040]">
                    Yordamchi o'qituvchini bron qilish blokini yoqish
                  </h1>
                </div>
                <div>
                  <div
                    onClick={() =>
                      set_attendance_assistant_limit(
                        !attendance_assistant_limit
                      )
                    }
                    className={`rounded-[40px] ${
                      attendance_assistant_limit ? "bg-[#264E86]" : "bg-white"
                    } w-[38px] flex ${
                      attendance_assistant_limit
                        ? "justify-end"
                        : "justify-start"
                  ...
                  >
                    <div
                      className={`h-[14px] ${
                        attendance_assistant_limit ? "bg-white" : "bg-[#264E86]"
                      } w-[14px] rounded-[50%] duration-[0.1s] ease-out`}
                    ></div>
                  </div>
                </div>
              ...
              <div className="w-full h-[68px] border-b-[1.5px] border-[#D9D9D9] flex justify-between items-center px-[10px]">
                ...
                <div>
                  <div
                    onClick={() =>
                      set_attendance_assistant_block(
                        !attendance_assistant_block
                      )
                    }
                    className={`rounded-[40px] ${
                      attendance_assistant_block ? "bg-[#264E86]" : "bg-white"
                    } w-[38px] flex ${
                      attendance_assistant_block
                        ? "justify-end"
                        : "justify-start"
                  ...
                  >
                    <div
                      className={`h-[14px] ${
                        attendance_assistant_block ? "bg-white" : "bg-[#264E86]"
                      } w-[14px] rounded-[50%] duration-[0.1s] ease-out`}
                    ></div>
                  </div>
                </div>
              ...
              <div className="w-full h-[148px] items-start gap-[20px] border-b-[1.5px] flex flex-col px-[10px]">
                <div className="w-[677px] mt-[20px]">
                  <h1 className="text-[18px] font-[500] font-[inter] text-[#404040]">
                    Davomatda hamma keldi turishi
                  </h1>
                </div>
                <div className="relative w-[248px] h-[67px]">
                  ...
                  >
                    <option className="w" value="Keldi">
                      Keldi
                    </option>
              ...
              <div className="w-full h-[148px] gap-[20px] border-b-[1.5px] flex flex-col px-[10px]">
                <div className="w-[677px] mt-[20px]">
                  <h1 className="text-[18px] font-[500] font-[inter] text-[#404040]">
                    O'qituvchining ish haqi ko'rsatkichi
                  </h1>
                </div>
                <div className="relative w-[248px] h-[67px]">
                  <select
                    ...
                    onChange={(e) =>
                      handle_workers_salary_change(e.target.value)
                    }
                    className="appearance-none w-full h-[67px] px-[30px] py-2 pr-10 border border-gray-300 rounded-md bg-[#F2EEEE] shadow-sm cursor-pointer font-roboto font-[500] text-[20px] text-black transition-all duration-150 ease-in-out focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 hover:border-blue-500"
                  >
                ...
                <div className="flex flex-row items-center justify-between">
                  ...
                  <div>
                    <div
                      ...
                      className={`rounded-[40px] ${
                        debtor_limit ? "bg-[#264E86]" : "bg-white"
                      } w-[38px] flex ${
                        debtor_limit ? "justify-end" : "justify-start"
                      } duration-[0.1s] ease-out cursor-pointer items-center px-[2px] border-[#264E86] border-[4px] h-[24px]`}
                    >
                      <div
                        className={`h-[14px] ${
                          debtor_limit ? "bg-white" : "bg-[#264E86]"
                        } w-[14px] rounded-[50%] duration-[0.1s] ease-out`}
                      ></div>
                    </div>
                  </div>
              ...
              <div className="w-full h-[62.17px] border-b-[1.5px] border-[#D9D9D9] flex justify-between items-center px-[10px]">
                ...
                <div>
                  <div
                    ...
                    className={`rounded-[40px] ${
                      report ? "bg-[#264E86]" : "bg-white"
                    } w-[38px] flex ${
                      report ? "justify-end" : "justify-start"
                    } duration-[0.1s] ease-out cursor-pointer items-center px-[2px] border-[#264E86] border-[4px] h-[24px]`}
                  >
                    <div
                      className={`h-[14px] ${
                        report ? "bg-white" : "bg-[#264E86]"
                      } w-[14px] rounded-[50%] duration-[0.1s] ease-out`}
                    ></div>
                  </div>
                </div>
              ...
              <div className="w-full h-[62.17px] border-b-[1.5px] border-[#D9D9D9] flex justify-between items-center px-[10px]">
                ...
                <div>
                  <div
                    ...
                    className={`rounded-[40px] ${
                      chat ? "bg-[#264E86]" : "bg-white"
                    } w-[38px] flex ${
                      chat ? "justify-end" : "justify-start"
                    } duration-[0.1s] ease-out cursor-pointer items-center px-[2px] border-[#264E86] border-[4px] h-[24px]`}
                  >
                    <div
                      className={`h-[14px] ${
                        chat ? "bg-white" : "bg-[#264E86]"
                      } w-[14px] rounded-[50%] duration-[0.1s] ease-out`}
                    ></div>
                  </div>
                </div>
              ...
              <div className="w-full h-[62.17px] border-b-[1.5px] border-[#D9D9D9] flex justify-between items-center px-[10px]">
                ...
                <div>
                  <div
                    ...
                    className={`rounded-[40px] ${
                      department ? "bg-[#264E86]" : "bg-white"
                    } w-[38px] flex ${
                      department ? "justify-end" : "justify-start"
                    } duration-[0.1s] ease-out cursor-pointer items-center px-[2px] border-[#264E86] border-[4px] h-[24px]`}
                  >
                    <div
                      className={`h-[14px] ${
                        department ? "bg-white" : "bg-[#264E86]"
                      } w-[14px] rounded-[50%] duration-[0.1s] ease-out`}
                    ></div>
                  </div>
                </div>
              ...
              <div className="w-full h-[62.17px] border-b-[1.5px] border-[#D9D9D9] flex justify-between items-center px-[10px]">
                ...
                <div>
                  <div
                    ...
                    className={`rounded-[40px] ${
                      worker_exercise ? "bg-[#264E86]" : "bg-white"
                    } w-[38px] flex ${
                      worker_exercise ? "justify-end" : "justify-start"
                    } duration-[0.1s] ease-out cursor-pointer items-center px-[2px] border-[#264E86] border-[4px] h-[24px]`}
                  >
                    <div
                      className={`h-[14px] ${
                        worker_exercise ? "bg-white" : "bg-[#264E86]"
                      } w-[14px] rounded-[50%] duration-[0.1s] ease-out`}
                    ></div>
                  </div>
                </div>
              ...
              <div className="w-full h-[62.17px] border-b-[1.5px] border-[#D9D9D9] flex justify-between items-center px-[10px]">
                ...
                <div>
                  <div
                    ...
                    className={`rounded-[40px] ${
                      drive ? "bg-[#264E86]" : "bg-white"
                    } w-[38px] flex ${
                      drive ? "justify-end" : "justify-start"
                    } duration-[0.1s] ease-out cursor-pointer items-center px-[2px] border-[#264E86] border-[4px] h-[24px]`}
                  >
                    <div
                      className={`h-[14px] ${
                        drive ? "bg-white" : "bg-[#264E86]"
                      } w-[14px] rounded-[50%] duration-[0.1s] ease-out`}
                    ></div>
                  </div>
                </div>
              ...
              <div className="w-full h-[62.17px] border-b-[1.5px] border-[#D9D9D9] flex justify-between items-center px-[10px]">
                ...
                <div>
                  <div
                    ...
                    className={`rounded-[40px] ${
                      control ? "bg-[#264E86]" : "bg-white"
                    } w-[38px] flex ${
                      control ? "justify-end" : "justify-start"
                    } duration-[0.1s] ease-out cursor-pointer items-center px-[2px] border-[#264E86] border-[4px] h-[24px]`}
                  >
                    <div
                      className={`h-[14px] ${
                        control ? "bg-white" : "bg-[#264E86]"
                      } w-[14px] rounded-[50%] duration-[0.1s] ease-out`}
                    ></div>
                  </div>
                </div>
              ...
              <div className="w-full h-[62.17px] border-b-[1.5px] border-[#D9D9D9] flex justify-between items-center px-[10px]">
                ...
                <div>
                  <div
                    ...
                    className={`rounded-[40px] ${
                      finance ? "bg-[#264E86]" : "bg-white"
                    } w-[38px] flex ${
                      finance ? "justify-end" : "justify-start"
                    } duration-[0.1s] ease-out cursor-pointer items-center px-[2px] border-[#264E86] border-[4px] h-[24px]`}
                  >
                    <div
                      className={`h-[14px] ${
                        finance ? "bg-white" : "bg-[#264E86]"
                      } w-[14px] rounded-[50%] duration-[0.1s] ease-out`}
                    ></div>
                  </div>
                </div>
              ...
              <div className="w-full h-[62.17px] border-b-[1.5px] border-[#D9D9D9] flex justify-between items-center px-[10px]">
                ...
                <div>
                  <div
                    ...
                    className={`rounded-[40px] ${
                      group ? "bg-[#264E86]" : "bg-white"
                    } w-[38px] flex ${
                      group ? "justify-end" : "justify-start"
                    } duration-[0.1s] ease-out cursor-pointer items-center px-[2px] border-[#264E86] border-[4px] h-[24px]`}
                  >
                    <div
                      className={`h-[14px] ${
                        group ? "bg-white" : "bg-[#264E86]"
                      } w-[14px] rounded-[50%] duration-[0.1s] ease-out`}
                    ></div>
                  </div>
                </div>
              ...
              <div className="w-full h-[62.17px] border-b-[1.5px] border-[#D9D9D9] flex justify-between items-center px-[10px]">
                ...
                <div>
                  <div
                    ...
                    className={`rounded-[40px] ${
                      main_page ? "bg-[#264E86]" : "bg-white"
                    } w-[38px] flex ${
                      main_page ? "justify-end" : "justify-start"
                    } duration-[0.1s] ease-out cursor-pointer items-center px-[2px] border-[#264E86] border-[4px] h-[24px]`}
                  >
                    <div
                      className={`h-[14px] ${
                        main_page ? "bg-white" : "bg-[#264E86]"
                      } w-[14px] rounded-[50%] duration-[0.1s] ease-out`}
                    ></div>
                  </div>
                </div>
              ...
              <div className="w-full h-[62.17px] border-b-[1.5px] border-[#D9D9D9] flex justify-between items-center px-[10px]">
                ...
                <div>
                  <div
                    ...
                    className={`rounded-[40px] ${
                      marketing ? "bg-[#264E86]" : "bg-white"
                    } w-[38px] flex ${
                      marketing ? "justify-end" : "justify-start"
                    } duration-[0.1s] ease-out cursor-pointer items-center px-[2px] border-[#264E86] border-[4px] h-[24px]`}
                  >
                    <div
                      className={`h-[14px] ${
                        marketing ? "bg-white" : "bg-[#264E86]"
                      } w-[14px] rounded-[50%] duration-[0.1s] ease-out`}
                    ></div>
                  </div>
                </div>
              ...
              <div className="w-full h-[62.17px] border-b-[1.5px] border-[#D9D9D9] flex justify-between items-center px-[10px]">
                ...
                <div>
                  <div
                    ...
                    className={`rounded-[40px] ${
                      student ? "bg-[#264E86]" : "bg-white"
                    } w-[38px] flex ${
                      student ? "justify-end" : "justify-start"
                    } duration-[0.1s] ease-out cursor-pointer items-center px-[2px] border-[#264E86] border-[4px] h-[24px]`}
                  >
                    <div
                      className={`h-[14px] ${
                        student ? "bg-white" : "bg-[#264E86]"
                      } w-[14px] rounded-[50%] duration-[0.1s] ease-out`}
                    ></div>
                  </div>
                </div>
              ...
              <div className="w-full flex flex-col gap-[20px] mt-[20px]">
                <div className="w-full flex flex-col justify-center items-start gap-[20px]">
                  <h1 className="text-[#404040] font-inter font-[500] text-[18px] leading-[21.78px]">
                    Pul yechish vaqti
                  </h1>
                ...
                <div className="w-full flex flex-col justify-center items-start gap-[20px]">
                  <h1 className="text-[#404040] font-inter font-[500] text-[18px] leading-[21.78px]">
                    Pro arxivda turish vaqti (Max 31)
                  </h1>
                    ...
                    <input
                      ...
                      onChange={() => {
                        if (
                          ...
                          document.getElementById("pro_archive").value.length >
                            2
                        ) {
                        }
                      }}
                ...
                <div className="absolute bg-black">
                  <button
                    ...
                    className={`fixed top-[1200px] left-[1710px] overflow-hidden w-[142px] h-[63px] rounded-md bg-[rgba(13,153,255,1)] transition-all duration-200 active:scale-95 text-white text-lg border-none cursor-pointer z-50 ${
                      loading ? "opacity-50" : ""
                    }`}
                    disabled={loading}
                  >
                  ...
                  <div
                    className={`absolute top-[-40px] opacity-30 rotate-[30deg] shadow-2xl shadow-black transform transition-all duration-300 ${
                      !loading && hovered
