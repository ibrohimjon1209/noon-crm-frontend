...
const Navbar = () => {
    ...
    const study_submenu_items = [
        { path: "/study_section/categoryStudy", active: "/study_section/categoryStudy", label: "Kategoriyalar" },
        { path: "/study_section/onlineCourses", active: "/study_section/onlineCourses", label: "Online kurslar" },
        { path: "/study_section/offlineCourses", active: "/study_section/offlineCourses", label: "Offline kurslar" },
    ];
