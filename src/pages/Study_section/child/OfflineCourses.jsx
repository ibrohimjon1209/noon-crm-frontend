...
const OfflineCourses = () => {
    ...
    const { data: courses, error } = useFetchData("/courses"); 

    const courseLevels = courses?.[0]?.course_levels ?? [];
    // const courses = [{
    //     id: 1, name: 'Ingliz tili', color: 'bg-green-500', levels: ['Boshlangich', 'O‘rta', 'Yuqori']
    // }]
