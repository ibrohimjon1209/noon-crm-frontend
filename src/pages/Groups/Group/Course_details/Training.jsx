...
import DeleteModal from './Training_modal/Delete_modal';
import EditModal from './Training_modal/Edit_modal';
...
const Training = () => {
  ...
  const [students, setStudents] = useState([
    {
      id: 1,
      name: 'Mening mashg‘ulotim',
      teacher: 'Hoshimjon Ro‘ziyev',
      checked: false, // Tanlanganlik holati
    },
    {
      id: 2, // Har biriga noyob ID
      name: 'Mening mashg‘ulotim',
      teacher: 'Hoshimjon Ro‘ziyev',
      checked: false,
    },
    {
      id: 3, // Har biriga noyob ID
      name: 'Mening mashg‘ulotim',
      teacher: 'Hoshimjon Ro‘ziyev',
      checked: false,
    },
      ...
      <table className="w-full mt-[30px] m-auto">
        <thead>
          <tr>
            ...
            <th className="h-[25px] p-2 text-left text-[23px] font-[450] text-gray-600">Mashg‘ulot nomi</th>
            <th className="h-[25px] p-2 text-left text-[23px] font-[450] text-gray-600">Yordamchi o‘qituvchilar</th>
          </tr>
        </thead>
