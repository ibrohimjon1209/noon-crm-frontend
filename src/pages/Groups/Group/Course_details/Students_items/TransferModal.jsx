      ...
      >
        ...
        <div className="flex flex-col w-[90%] h-[300px] m-auto gap-5">
          <div className="space-y-[20px] pt-[30px]">
            <label className="font-roboto font-[400] block text-[18px] leading-[21.09px] text-black">O’qituvchini tanlang</label>
            <input
              type="text"
            ...
            <label className="font-roboto font-[400] block text-[18px] leading-[21.09px] text-black">guruhni tanlang</label>
            <input
              type="text"
              className="w-[100%] h-[45px] p-2 border border-gray-300 text-black text-[17px] bg-[#F2EEEE] rounded-md"
