...
const Test = () => {
  ...
  return (
    ...
    <div>
      <div  className={`${is_filter_open ? 'h-[calc(20vh-20px)]' : 'h-[20px]'} mt-[30px] h-[55px]`}>
      ...
      <div className='pt-[20px] px-[32px] pb-[33px]'>
        <div className={`w-full ${is_filter_open ? 'h-[calc(136vh-320px)]' : 'h-[calc(140vh-320px)]'} shadow-lg shadow-[rgba(0,0,0,0.25)] rounded-[15px] pb-[50px] pt-[15px] px-[18px] bg-[rgba(255,255,255,1)] overflow-hidden`}>
