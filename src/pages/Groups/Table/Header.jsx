...
const Header = ({ is_filter_open, set_is_filter_open, set_is_add_modal_open }) => {
    ...
    return (
        <div className="w-full">
            <div className="w-[100%] h-auto px-[2%] flex flex-row justify-between items-baseline">
                <h1 className="font-[roboto] font-[100] text-[20px] leading-[23.44px] text-[#264E86]"></h1>
            ...
            <div
                className={`flex flex-row justify-end pr-[2%] gap-[10px] pl-[130px] transition-all duration-[0.3s] ease-out ${is_filter_open ? "translate-y-0 h-auto pt-[25px] -mb-[5px] opacity-100" : "opacity-0 h-0 overflow-hidden"
                    }`}
            >
                <div
                ...
                >
                    ...
                    <div
                        className={`absolute  top-[60px] left-0 w-full bg-white border-[#C5C5C5] shadow-md rounded-[5px] z-50 overflow-hidden transition-all duration-[300ms] ease-out ${is_human_open ? `h-[250px] mt-[5px] border-[1.5px] ${humans_list.length > 4 ? 'overflow-y-scroll' : 'overflow-y-hidden'} menu_scroll` : 'h-0 border-0'
                            }`}
                    >
