...
const Test = () => {
    ...
    return (
        <div className='pt-[0px] px-[32px] '>
            <div className="w-full h-full shadow-lg shadow-[rgba(0,0,0,0.25)] rounded-[15px] pt-[15px] px-[18px] bg-[rgba(255,255,255,1)] overflow-x-auto">
                {/* Days header */}
                        ...
                        <button
                            ...
                            className={classNames(
                                ...
                                day === activeDay
                                    ...
                                    : "bg-[rgba(242,238,238,1)] hover:bg-[#e6e4e4]"
                            )}
                        >
                            {day}
                        </button>
